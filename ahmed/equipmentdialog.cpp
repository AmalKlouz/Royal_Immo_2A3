    ...
    ui(new Ui::EquipmentDialog)
{
    ...
    //initially set current page to 0
        ...
        connect(ui->Add_button_equi, &QPushButton::clicked, this, [=]() {
            //set page to 1
            ui->stackedWidget->setCurrentIndex(1);
        });
     ...
     connect(ui->UpdateEQUI_button, &QPushButton::clicked, this, [=]() {
         //set page to 1
         ui->stackedWidget->setCurrentIndex(1);
     });
...
void EquipmentDialog::on_Add_button_equi_clicked()
{
    ...
    int id=ui->eID->text().toInt ();
     ...
     QString etat="";
     if(ui->radioButton_etat->isChecked()){etat =ui->radioButton_etat->text();}
     else if (ui->radioButton_etat_2->isChecked()){etat =ui->radioButton_etat_2->text();}
     Equipement E(id,marque,type,etat);
     bool testEQU=E.ajouter();
     qDebug() <<  testEQU;
...
void EquipmentDialog::on_delete_equi_btn_clicked()
{
    ui->tableView->setModel (Etmp.afficher());
    int val=ui->comboBox->currentText().toInt();
    Etmp.setID(val);
    bool testEQU=Etmp.supprimer(Etmp.getID());
    if(testEQU){
        QSqlQueryModel * modal=new QSqlQueryModel ();
        QSqlQuery* qry=new QSqlQuery ();
        qry->prepare ("select ID from EQUIPEMENT ");
...
void EquipmentDialog::on_pushButton_AjouterLink_clicked()
{

}

void EquipmentDialog::on_update_btn_clicked()
{
    QSqlQueryModel * modal=new QSqlQueryModel ();
    QSqlQuery* qry=new QSqlQuery ();
...
void EquipmentDialog::on_id_comboBox_currentTextChanged(const QString &arg1)
{
...
void EquipmentDialog::on_UpdateEQUI_button_clicked()
{
    ui->tableView->setModel (Etmp.afficher());
     int s_id=ui->id_comboBox->currentText().toInt();
     ...
     if(ui->radioButton_3->isChecked()){etat =ui->radioButton_3->text();}
            ...
            bool testEQU = E.update(s_id,marque,type,etat);
            if (testEQU)
                  {
...
void EquipmentDialog::on_comboBox_currentTextChanged(const QString &arg1)
{

}

void EquipmentDialog::on_tri_id_equi_clicked()
{
    {
            QMessageBox msgBox ;
...
void EquipmentDialog::on_tri_nom_equi_clicked()
{
{
    QMessageBox msgBox ;
            QSqlQueryModel * model= new QSqlQueryModel();
...
void EquipmentDialog::on_tri_date_ajout_equi_clicked()
{
    {
    QMessageBox msgBox ;
            QSqlQueryModel * model= new QSqlQueryModel();
...
void EquipmentDialog::on_pdf_equi_btn_clicked()
{
    QString strStream;
...
void EquipmentDialog::on_QR_equi_btn_clicked()
{
    int val=ui->comboBox->currentText().toInt();
...
void EquipmentDialog::on_RechercheEQUI_textChanged(const QString &arg1)
{
    Equipement E;
    if(ui->RechercheEQUI->text() == " " )
            {
                ui->tableView->setModel(E.afficher());
            }
            else
            {
                 ui->tableView->setModel(E.rechercher(ui->RechercheEQUI->text()));
            }
}

void EquipmentDialog::update_label()
{
   data=A.read_from_arduino();
...
void EquipmentDialog::on_addBarcode_clicked()
{
...
void EquipmentDialog::on_arduino_clicked()
{
    QSqlQueryModel * modal=new QSqlQueryModel ();
    QSqlQuery* qry=new QSqlQuery ();
    qry->prepare ("select ID from EQUIPEMENT ");
