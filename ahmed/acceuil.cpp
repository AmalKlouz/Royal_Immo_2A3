    ...
    , ui(new Ui::acceuil)
{
    ...
    QSqlQuery q("select adresse,count(*) from employee group by adresse");
...
void acceuil::on_ButtonAjouterEmploye_clicked()
{
...
void acceuil::on_ButtonModifierEmploye_clicked()
{
    int id=ui->ID->text().toInt();
    QString nom=ui->NOM->text();
    QString prenom=ui->PRENOM->text();
...
void acceuil::on_ButtonSupprimerEmploye_clicked()
{
...
void acceuil::on_recuperer_clicked()
{
    int row =ui->tableEmploye->selectionModel()->currentIndex().row();
           QString id=ui->tableEmploye->model()->index(row,0).data().toString();
           QSqlQuery q("select * from employee where id="+id);
    ...
    QString strStream;
                   ...
                   "<head>\n"
                                   ...
                                   //     "<align='right'> " << datefich << "</align>"
                                        "<img src='C:/Users/Amal/Desktop/logo.png'"
